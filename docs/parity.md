...
The Go SDK (`github.com/TH1015/claude-agent-sdk-go`) implements all features from the Python SDK (`claude-agent-sdk`) with additional Go-idiomatic enhancements.
...
**Go:**
```go
import "github.com/TH1015/claude-agent-sdk-go"
